...
| E01240012 | The specified member ID is duplicated in the file (※ time Araikawa)	|
...
| W0100W616 | Storage process item check-time error (payment amount ≦ 0)	|
...
| NC1000004 | ￼ state transition check error (payment already)	|
